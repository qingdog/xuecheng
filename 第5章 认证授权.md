...
![](./imgs/chapter5/image3.png)

用户输入账号和密码提交认证，认证通过继续操作。

项目由统一认证服务受理用户的认证请求，如下图：

![](./imgs/chapter5/image4.png)
...
![](./imgs/chapter5/image8.png)

访问用户信息：http://localhost:63070/auth/user/52 

![](./imgs/chapter5/image9.png)
...
![](./imgs/chapter5/image16.png)

![](./imgs/chapter5/image17.png)
...
![](./imgs/chapter5/image29.png)

仔细观察此图，遗漏了本项目架构中非常重要的组件：网关，加上网关并完善后如下图所示：

![](./imgs/chapter5/image30.png)
...
* [GatewayAuthFilter.java](https://github.com/qingdog/xuecheng/blob/master/xuecheng-plus-gateway/src/main/java/com/xuecheng/config/GatewayAuthFilter.java)
...
![](./imgs/chapter5/image41.png)

执行流程如下：

![](./imgs/chapter5/image42.png)
...
![](./imgs/chapter5/image46.png)

![](./imgs/chapter5/image47.png)
...
![](./imgs/chapter5/image51.png)

响应：

![](./imgs/chapter5/image52.png)
...
![](./imgs/chapter5/image54.png)

1、在内网穿透服务器上开通隧道，配置外网域名，配置穿透内网的端口即本地电脑上的端口。

![](./imgs/chapter5/image55.png)
...
![](./imgs/chapter5/image57.png)

点击微信图标打开二维码

![](./imgs/chapter5/image58.png)
...
![](./imgs/chapter5/image62.png)

当用户没有权限时页面提示：没有操作此功能的权限。

![](./imgs/chapter5/image63.png)
...
![](./imgs/chapter5/image69.png)

跟踪持久层日志发现已将机构id传入dao方法，拼装sql语句，查询本机构的课程信息

![](./imgs/chapter5/image70.png)
